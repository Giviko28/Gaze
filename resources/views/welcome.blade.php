    ...
    <nav class="flex justify-between items-center whitespace-nowrap">
        ...
        <div class="space-x-6">
            ...
            @else
                ...
                <a href="/register" class="rounded-xl border px-2.5 py-1.5 border-sky-400 hover:text-white hover:bg-sky-400 hover:duration-300">Sign Up</a>
            @endauth
        </div>
    </nav>
</body>
